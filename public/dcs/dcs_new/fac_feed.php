...
<div class='col-md-12'  >
  <div class='panel panel-primary'>
   ...
   <?php
    ...
    if($a==2)
    echo "<tr>"."<td align='right'>"."Particular Month:"."</td>"."<td>"."<input type='radio' value='1' name='choice' checked='checked'/>"."</td>"."</tr>";
    else if($a==1)
    echo "<tr>"."<td align='right'>"."Upto Certain Month:"."</td>"."<td>"."<input type='radio' value='2' name='choice' />"."</td>"."</tr>";
    else
    {
    echo "<tr>"."<td align='right'>"."Particular Month:"."</td>"."<td>"."<input type='radio' value='1' name='choice' checked='checked'/>"."</td>"."</tr>";
      echo "<tr>"."<td align='right'>"."Upto Certain Month:"."</td>"."<td>"."<input type='radio' value='2' name='choice' />"."</td>"."</tr>";
 ...
 ?>
    ...
    <td align="right">	Semester:</td><td>
        ...
        <script>
				...
				if(myObj.val==1)
				{
					alert("Data of selected month and year of this subject is Already Entered.Press OK to continue.");
					window.location="maps.php";

				}
				else
				alert("You haven't Entered Attendance of selected month. Click here to proceed");
					
			
                            }
                        };
                        
i.open("GET","fac_chk_entry_ajax.php?month=" + month + "&year=" + year + "&subjectid=" + subjectid + "&semester=" + semester + "&section=" + section +"&batch="+batch ,true);
                        i.send();	
                } 
        </script>
