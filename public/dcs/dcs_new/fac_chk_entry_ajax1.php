...
<?php
	...
	if($feed_count!=0)
	{
    echo "Data of $month $year of this subject is Present.Please Proceed";	
   ...
   //include("login_redirect2.php");
	...
	{
			echo "You haven't Entered Attendance of $month $year!!";	
	}
	?>
<script>
document.getElementsId('validate').disabled=true;
