...
<div class="w3-container">
	...
	<div class="w3-row w3-center">
		...
		<div class="w3-col m2">
				...
				<a href="<?php echo $res->action?>/admin/create_test" class='w3-btn w3-large w3-ripple w3-border w3-round'>
		...
		<div class="w3-col m2">
				...
				<a href="<?php echo $res->action?>/admin/conduct_test" class='w3-btn w3-large w3-ripple w3-border w3-round'>
		...
		<div class="w3-col m2">
			<a href="<?php echo $res->action?>/admin/invigilation" class='w3-btn w3-large w3-ripple w3-border w3-round'>
	...
	<div class="w3-row w3-center w3-margin-top">
		...
		<div class="w3-col m2">
				...
				<a href="<?php echo $res->action?>/admin/edit_test" class='w3-btn w3-large w3-ripple w3-border w3-round'>
		...
		<div class="w3-col m2">
				...
				<a href="<?php echo $res->action?>/admin/student_report" class='w3-btn w3-large w3-ripple w3-border w3-round'>
		...
		<div class="w3-col m2">
				...
				<a href="<?php echo $res->action?>/admin/live_test" class='w3-btn w3-large w3-ripple w3-border w3-round'>
