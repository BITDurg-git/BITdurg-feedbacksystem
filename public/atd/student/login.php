...
else
{
	var i=new XMLHttpRequest();
			...
			i.open("POST","checklogincredentials.php?login_name=" + user_name + "&password="+ password ,true);
			i.send();
}
...
<div class="container"  >
	...
	<div class="col-md-6">
		...
		<form method="post" action="checklogin.php" name="form1">
			...
			<div class="panel-body">
				<table class="table">
 	    <tr><td>User</td><td><input type="text" required name="login_name" id="login_name" class="form-control" placeholder="university rollno"></td></tr>
 		<tr><td>Password</td><td><input type="password" required name="login_pwd" id="login_pwd" class="form-control" placeholder="university rollno"></td></tr>
 	</table>
	...
	<div class="row" style="margin-bottom: 0%; ">
		...
		<div class="col-md-6">
			...
			<div class='panel-heading'><h3 class='panel-title' " id="errormsg" ><marquee >Do you have any problem? Please contact Admin.</marquee>
	<marquee><font color="red" >Your University rollno is your username and password</font> </marquee>
</h3></div>
		</div>
