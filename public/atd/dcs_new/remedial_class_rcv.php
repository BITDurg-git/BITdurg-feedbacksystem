...
<div class='panel-heading' ><h3 class='panel-title' align="center" >Bhilai Institute Of Technology</h3></div>
    ...
    <?php
    if($radio_choice==1)
    echo"<font size='2'>"."List of Remedial Students : SEMESTER : ".$semester." / "." SECTION : ".$section." / "."MONTH : IN ".$month." ".$year."</font>";
	else
   ...
   <!-- <th style="background-color:#8fbc8f">Attendance(%)</th>
    ...
    <?php
          ...
          for($p=$month_id;$p>=1;$p--)
          {
            	...
            	echo"<th  width='10%'>"."<font size='2'>"."Percentage -".$month1."</font>"."</th>";
		       }
   echo"</tr>";
  ...
  //	echo"<th>"."<font size='2'>"."100%"."</th>";
	//	echo"</tr>";
		...
		while($student_res1=mysqli_fetch_array($student_res))
		{
			...
			//$subject_res=mysqli_query($con,"select subject_id from subject_master where semester=$semester && section='$section' order by subject_id");
    ...
    if ($count_red == $count_month)
    {
    	$temp_student_name=$student_res1[0];
			$temp_class_roll=$student_res1[1];
			$temp_student_id=$student_res1[2];
     echo "<tr >"."<td  width='20%' class='text-center'>"."<font size='2' >".$temp_class_roll."</td>"."<td class='text-center'>"."<font size='2'>".$temp_student_name."</td>";
     for ($x=0;$x<$ab;$x++)
     echo "<td class='danger' width='10%'>"."<font size='2' color='#000'>".number_format((float)$perc1[$x],2,'.','')."</td>";			
        echo "</tr>";
    }
...
else if($radio_choice==2)
{
    ...
    <?php
		...
		for($p=$month_id;$p>=1;$p--)
          ...
          echo"<th  width='10%'>"."<font size='2'>"."Percentage Up to-".$month1."</font>"."</th>";
		       }
   echo"</tr>";
   ...
   //   echo"<td align='center' bgcolor='#00FF00'>"."<font size='2'>".number_format((float)$perc,2, '.', '')."</font>"."</td>";
       ...
       if ($count_red == $count_month)
    {
    	$temp_student_name=$student_res1[0];
			$temp_class_roll=$student_res1[1];
			$temp_student_id=$student_res1[2];
      echo "<tr>"."<td  width='10%' class='text-center'>"."<font size='2'>".$temp_class_roll."</td>"."<td class='text-center' >"."<font size='2'>".$temp_student_name."</td>";
      for ($x=0;$x<$ab;$x++)
         echo "<td width='10%' class='danger'>"."<font size='2'>".number_format((float)$perc1[$x],2,'.','')."</td>";			
        echo "</tr>";
    }      
		//	echo"</tr>";
